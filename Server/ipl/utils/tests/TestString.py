...
class TestString(unittest.TestCase):
    ...
    def test_expandCSharpString_plainString(self):
        ...
        self.assertTrue(plain == newPlain, 'Testing plain string')
    ...
    def test_expandCSharpString(self):
        ...
        for (a, b) in data:
            ...
            self.assertTrue(newStr == '%s = %s' % (a, b), 'Testing expandCSharpString with %s' % str(data))
    ...
    def test_expandCSharpString_examples(self):
        ...
        self.assertTrue(example1 == 'After 42 cycles, state = IDLE')
        self.assertTrue(example2 == 'My first name is Graeme and my last name is Cross')

    
    def test_expandCSharpString_swappedParameters(self):
        input = '{1} + {0} = {2}'
        newStr = expandCSharpString(input, (2, 3, 5))
        self.assertTrue(newStr == '3 + 2 = 5', 'Testing swapped parameters')
