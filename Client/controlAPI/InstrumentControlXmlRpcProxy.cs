...
/*CR*/	public string[][] GetCustomNames()
        ...
        [XmlRpcMethod("SetIgnoreHydraulicSensor")]                  //CWJ
        public int SetIgnoreHydraulicSensor(int sw)
        {
            int rtn = -1;
            try
            {
                rtn = (int)Invoke("SetIgnoreHydraulicSensor", new object[1] { sw });
                return rtn;
        ...
        [XmlRpcMethod("GetIgnoreHydraulicSensor")]                  //CWJ
        public bool GetIgnoreHydraulicSensor()
        {
            bool rtn = false;
            try
            {
                rtn = (bool)Invoke("GetIgnoreHydraulicSensor");
                return rtn;
            }
            finally { }
        }
        ...
        public int InitScanVialBarcode(bool freeaxis)
        {
            int rtn = -1;
            try
            {
                rtn = (int)Invoke("InitScanVialBarcode", new object[1]{freeaxis});
                return rtn;
        ...
        [XmlRpcMethod("AbortScanVialBarcode")]        //twong
        public bool AbortScanVialBarcode()
        {
            try
            {
                return (bool)Invoke("AbortScanVialBarcode");
            }
            finally { }
        }

        [XmlRpcMethod("IsBarcodeScanningDone")]        //twong
        public bool IsBarcodeScanningDone()
        {
            bool rtn = false;
            try
            {
                rtn = (bool)Invoke("IsBarcodeScanningDone");
                return rtn;
            }
            finally { }
        }
        ...
        [XmlRpcMethod("GetEndOfRunXMLFullFileName")]        // 09-25-2013 - Sunny added
        public string GetEndOfRunXMLFullFileName()
        {
            string rtn = "Error";
            try
            {
                rtn = (string)Invoke("GetEndOfRunXMLFullFileName");
                return rtn;
        ...
        [XmlRpcMethod("getProtocolCommandList")]
        public XmlRpcProtocolCommand[] getProtocolCommandList(int protocolIdx)
        {
            try
            {
#if false
                return (XmlRpcProtocolCommand[])Invoke("getProtocolCommandList", new object[1] { protocolIdx });
#else
                object obj;
                LogFile.AddMessage(System.Diagnostics.TraceLevel.Verbose, ">>>>>>> Entering to getProtocolCommandList at XMLRpcProxy");                            
                obj = (object)Invoke("getProtocolCommandList", new object[1] { protocolIdx });
                LogFile.AddMessage(System.Diagnostics.TraceLevel.Verbose, ">>>>>>> Leaving getProtocolCommandList at XMLRpcProxy");                            

                return (XmlRpcProtocolCommand[])obj;
#endif
            }
            finally
            {
        ...
        /// </summary>
        /// <returns></returns>
        [XmlRpcMethod("isSharingComboValid")]
        public string isSharingComboValid(XmlRpcSample[] samples, string batchRunUserId, bool isSharing, int[] sharedSectorsTranslation, int[] sharedSectorsProtocolIndex)
        {
            try
            {
                return (string)Invoke("isSharingComboValid", samples, batchRunUserId,
                    isSharing, sharedSectorsTranslation, sharedSectorsProtocolIndex);
            }
            finally
            {
