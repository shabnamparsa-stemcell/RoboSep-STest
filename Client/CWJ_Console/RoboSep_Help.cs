...
namespace GUI_Console
{
    public partial class RoboSep_Help : UserControl
    {
        ...
        {
            int nCurrentTab = HelpTabs.CurrentTab;

            if (TabCheck != nCurrentTab)
            {
                Load_TabControl(nCurrentTab);
                RoboSep_UserConsole.intCurrentHelpTab = nCurrentTab;
            }

            // LOG
            string logMSG = "Load Tab Page " + nCurrentTab.ToString();
