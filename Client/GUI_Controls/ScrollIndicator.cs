...
namespace GUI_Controls
{
    public partial class ScrollIndicator : Control, ICustomScrollbar
    {
        ...
        private Color[,] aColorSchema = new Color[,]
            {
                {
                    Color.White, Color.Purple, Color.Silver, Color.FromArgb(194, 164, 217), Color.FromArgb(194, 164, 217), Color.Gainsboro,
                    Color.FromArgb(78, 38, 131), Color.FromArgb(78, 38, 131)
                },
                {
        ...
        private ColorSchemas colorSchema = ColorSchemas.PerlPurple;
