...
namespace GUI_Controls
{
    ...
    public partial class RoboMessagePanel : Form
    {
        ...
        private void SetDialogProperties()
        {
            ...
            ilist.Add(Properties.Resources.KeybaordButton_Wide);
            ilist.Add(Properties.Resources.KeybaordButton_Wide);
            ilist.Add(Properties.Resources.KeybaordButton_Wide);
            ilist.Add(Properties.Resources.KeybaordButton_Wide3);
        ...
        private void RoboMessagePanel_Load(object sender, EventArgs e)
        {
            ...
            this.button_1.ChangeGraphics(ilist);
            this.button_2.ChangeGraphics(ilist);
            if (msgIcon == MessageIcon.MBICON_NOTAPPLICABLE)
            {
