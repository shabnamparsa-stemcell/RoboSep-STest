...
namespace Tesla.Separator
{
	...
	public class SeparatorDataStore : SeparatorDataSource
	{
		...
		{
			return theDataStore.Protocol.FindByProtocolId(protocolId).ProtocolInstrumentControlId;
		}

		public int GetProtocolQuadrantCount(int protocolId)
		{
			return theDataStore.Protocol.FindByProtocolId(protocolId).ProtocolQuadrantCount;
		}
