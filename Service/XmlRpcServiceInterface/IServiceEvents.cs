...
namespace Tesla.InstrumentControl
{
	...
	/// 
	/// </summary>
	public delegate void ReportStatusDelegate(string state, string statusMessage);

    /// <summary>
    /// 
    /// </summary>
    public delegate void ReportErrorDelegate(int severityLevel, string errorMessage);	

	/// <summary>
	/// 
	/// </summary>
	public delegate void ReportCommsStateDelegate(string commsState);
	...
	{	
		...
		[XmlRpcMethod]
		bool reportStatus(string state, string statusCode, 
		...
		[XmlRpcMethod]
		bool reportError(int severityLevel, string errorCode, 
	...
	/// Public events API for the InstrumentControl subsystem.
	/// </summary>
	public interface IServiceSupportEvents
	{	
		#region events
		...
		/// 
		/// </summary>
		event ReportCommsStateDelegate					ReportCommsState;
