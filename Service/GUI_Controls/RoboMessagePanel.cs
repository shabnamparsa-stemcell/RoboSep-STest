...
namespace GUI_Controls
{
    public partial class RoboMessagePanel : Form
    {
        ...
        public RoboMessagePanel(Form PrevForm, string Message)
        {
            InitializeComponent();
            SuspendLayout();
            // set previous form
        ...
        public RoboMessagePanel(Form PrevForm, string Message, string panelName, string OkButton)
        {
            InitializeComponent();
            SuspendLayout();
            // set previous form
        ...
        public RoboMessagePanel(Form PrevForm, string Message, string Title, string b1, string b2)
        {
            InitializeComponent();
            SuspendLayout();
            // set previous form
        ...
        public RoboMessagePanel(Form PrevForm, string Message, bool isWaitDialog, bool showProgress)
        {
