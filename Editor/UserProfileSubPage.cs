...
namespace Tesla.OperatorConsoleControls
{
	public class UserProfileSubPage : Tesla.OperatorConsoleControls.RoboSepSubPage
	{
        ...
        // 2011-09-08
        // define the ssytem installed path (to use as a replacement for the fixed path
        private String installPath = Tesla.Common.Utilities.GetInstalledPath();
		...
		private void btnEditor_Click(object sender, System.EventArgs e)
		{
            ...
            process.StartInfo.FileName = installPath + "bin\\ProtocolEditor.exe"; //"rundll32.exe";
            process.StartInfo.WorkingDirectory = installPath + "bin\\";
